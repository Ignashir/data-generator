...
class HourGenerator:
    @staticmethod
    def generate_hours(begin: int, end: int):
    ...
    def __init__(self, /, reset_limit: Optional[int] = 2, begin: Optional[int] = 8, end: Optional[int] = 18):
        self.limit = reset_limit
        self.count = 0
        self.func = HourGenerator.generate_hours
        self.begin_arg = begin
        self.end_arg = end
        self.func_gen = self.func(self.begin_arg, self.end_arg)
